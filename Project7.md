...
You should include in your submission:
  ...
  4. Bash script that automates dependency installation and Spark job scheduling
  ...
  For 2, 3, and 4, please indicate in your submission email where in the repo these files are (don't attach it).
